...
@section('title', 'Ubah Grafik')

@section('content')
    <div class="admin modern-page">
        <h2 class="modern-page__heading">Form Ubah Grafik</h2>
            ...
            <form method="POST" action="{{ route('admin.datasets.update', ['dashboardDataset' => $dataset->id]) }}">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="title" name="title" class="form-control" value="{{ old('title', $dataset->title) }}" required>
                    </div>
                    <div class="col-md-6">
